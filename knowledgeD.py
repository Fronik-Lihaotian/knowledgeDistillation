...
def main(args):
    ...
    if args.fine_tuning:
        student_logger = get_logger(
            './logfile/explog_student_network_{}epochs_on_{}_tmp=10.log'.format(args.s_epochs, args.dataset))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--student_path', type=str, default='./student_weights/MobileNets_tmp=10.pth')
    parser.add_argument('--kl_tmp', type=float, default=10)
